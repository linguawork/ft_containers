...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   RoyRBTDELETErules.cpp                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: areggie <areggie@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/05/31 14:16:50 by areggie           #+#    #+#             */
/*   Updated: 2022/06/05 14:02:31 by areggie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	RBT deletion: (Mr.Tushar Roy! Clear explanation!) The insertion part is in another file;
	https://www.youtube.com/watch?v=CTvfzU_uNKE&list=PLYlfM6qKBI5indgvpVEzTlMh8sXt_I6XD&index=4
	There are 6 rules of deletion that can co-occur;
	...
	28:38 summary 
	30:30 code (the code is in JAVA), below is the code to deletion.
